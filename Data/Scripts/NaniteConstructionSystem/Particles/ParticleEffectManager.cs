...
namespace NaniteConstructionSystem.Particles
{
    public class ParticleEffectManager
    {
        ...
        public void AddParticle(long targetGridId, Vector3I position, int effectId)
        {
    ...
    public class TargetEntity
    {
        ...
        public TargetEntity(long targetGridId, Vector3I targetPosition, int effectId)
        {
            m_targetGridId = targetGridId;
            m_targetPosition = targetPosition;
            MyParticlesManager.TryCreateParticleEffect(effectId, out m_particle);
        }
