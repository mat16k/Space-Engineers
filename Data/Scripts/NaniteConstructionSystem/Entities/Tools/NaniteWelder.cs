...
{
    public class NaniteWelder : NaniteToolBase
    {
        private const string m_welderGrid = @"
    <MyObjectBuilder_CubeGrid xmlns:xsd=""http://www.w3.org/2001/XMLSchema"" xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"">
      ...
      <CubeBlocks>
        ...
        <MyObjectBuilder_CubeBlock xsi:type=""MyObjectBuilder_ShipWelder"">
          <SubtypeName>{0}NaniteShipWelder</SubtypeName>
          <EntityId>0</EntityId>
          <Min x=""1"" y=""-1"" z=""0"" />
      ...
      <LocalCoordSys>0</LocalCoordSys>
        ...
        public NaniteWelder(NaniteConstructionBlock constructionBlock, IMySlimBlock block, int waitTime, bool performanceFriendly) : base(constructionBlock, block, waitTime, m_welderGrid, performanceFriendly, false)
        {
        }
    }
}
